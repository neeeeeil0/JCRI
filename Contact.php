<section id="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="process.php?action=sendmail" method="POST" name="sentMessage" id="contactForm" novalidate
                    class="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-2xl space-y-4">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <input type="text" name="fullname"
                                class="form-control w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div id="success" class="text-center text-green-500 text-sm"></div>
                    <button type="submit" name="submit"
                        class="btn btn-primary w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-200">Send</button>
                </form>
            </div>
            ...
            <div class="col-md-6">
                ...
                <script type="text/javascript">
                    function init_map() {
                        console.log("init_map() is being called"); // Debugging line
                        var myOptions = {
                            zoom: 14,
                            center: new google.maps.LatLng(14.6021584, 121.0083393),
                        ...
                        marker = new google.maps.Marker({
                            map: map,
                            position: new google.maps.LatLng(14.6021584, 121.0083393)
                        });
                        infowindow = new google.maps.InfoWindow({
                            content: "<b>Santa Mesa</b><br/>Manila<br/> Philippines"
                        });
                    ...
                    function loadGoogleMaps() {
                        ...
                        script.src = 'https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&callback=init_map'; // **CRITICAL: ENSURE YOUR API KEY IS HERE**
                        script.async = true;
