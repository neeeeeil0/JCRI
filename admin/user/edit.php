                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_CONTACT" name="U_CONTACT" placeholder=
                            "Account Contact No" type="text" value="<?php echo $singleuser->CONTACT; ?>">
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_EMAIL" name="U_EMAIL" placeholder=
                            "Account Email" type="text" value="<?php echo $singleuser->EMAIL; ?>">
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_PASS" name="U_PASS" placeholder=
                            "Account Password (Optional)" type="Password" value="">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
